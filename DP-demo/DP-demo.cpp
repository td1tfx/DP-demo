...
int main()
{
	...
	in_data[0] = new double[in_num] {0, 0};
	in_data[1] = new double[in_num] {0, 1};
	in_data[2] = new double[in_num] {1, 0};
	in_data[3] = new double[in_num] {1, 1};
	double** bench_data = new double*[batch_num];
	bench_data[0] = new double[out_num] {0};
	bench_data[1] = new double[out_num] {0};
	bench_data[2] = new double[out_num] {0};
	bench_data[3] = new double[out_num] {1};
